...
namespace Vci.Silverlight.FileUploader
{
	public partial class FileListItemControl : UserControl
	{
		...
		public FileListItemControl()
		{
            ...
            this.txtName.MouseLeftButtonDown += new MouseButtonEventHandler(txtName_MouseLeftButtonDown);
		}

        void txtName_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
        ...
        {
            MessageBoxResult ret = MessageBox.Show(UserFile.FileName + "은 영구히 삭제됩니다.", "경고", MessageBoxButton.OKCancel);
