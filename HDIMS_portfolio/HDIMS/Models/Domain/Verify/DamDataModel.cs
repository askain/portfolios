...
namespace HDIMS.Models.Domain.Verify
{
    public class DamDataModel
    {
        ...
        public string SPDQTY { get; set; } //여수로방류량(수문방류량)
        ...
        public string RWL_CK { get; set; } //저수위
        public string OSPILWL_CK { get; set; } //방수로수위
        public string ETCIQTY2_CK { get; set; } //기타유입량2
        public string EDQTY_CK { get; set; } //발전방류량
        public string ETCEDQTY_CK { get; set; } //기타발전방류량
        public string SPDQTY_CK { get; set; } //여수로방류량(수문방류량)
        public string ETCDQTY1_CK { get; set; } //기타방류량1
        public string ETCDQTY2_CK { get; set; } //기타방류량2
        public string ETCDQTY3_CK { get; set; } //기타방류량3
        public string OTLTDQTY_CK { get; set; } //아울렛방류량
        public string ITQTY1_CK { get; set; } //취수량1
        public string ITQTY2_CK { get; set; } //취수량2
        public string ITQTY3_CK { get; set; } //취수량3
