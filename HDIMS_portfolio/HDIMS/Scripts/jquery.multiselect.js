    ...
    $.widget("ech.multiselect", {
        ...
        _bindEvents: function () {
			...
			.delegate('a', 'click.multiselect', function (e) {
			    //console.log("header a  click event");
			    // close link
			...
			.delegate('li.ui-multiselect-optgroup-label a', 'click.multiselect', function (e) {
			    //console.log("li.ui-multiselect-optgroup-label a click event");
			    e.preventDefault();
			...
			.delegate('label', 'mouseenter.multiselect', function () {
			    //console.log("header label mouseenter.multiselect");
			    if (!$(this).hasClass('ui-state-disabled')) {
			        self.labels.removeClass('ui-state-hover');
			        //$(this).addClass('ui-state-hover').find('input').focus();
			        //console.log("addClass ui-state-hover find input");
			    }
			})
			.delegate('label', 'keydown.multiselect', function (e) {
			    //console.log("header label keydown event");
			    e.preventDefault();
			...
			.delegate('input[type="checkbox"], input[type="radio"]', 'click.multiselect', function (e) {
			    //console.log("header checkbox click event");
			    var $this = $(this),
					val = this.value,
            ...
            this.menu.bind('mouseleave.multiselect', function (e) {
...
//                    //console.log("document mousedown.multiselect 2");
//                    self.close();
//                }
//            });
            ...
            $(this.element[0].form).bind('reset.multiselect', function () {
                //console.log("document reset.multiselect 1");
