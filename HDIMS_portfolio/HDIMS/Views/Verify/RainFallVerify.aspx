...
<script type="text/javascript">
    ...
    var chartVars = {
        ...
        settings_file: "/Config/Chart/VerifyRainFallSettings.xml",
    ...
    var legendNum = 3;
    var DataUrl = "/Verify/GetRainFallVerifyList/";
    var ExcelUrl = "/Verify/GetRainFallSearchExcel/?";
...
//        // 그리드 행갯수 리턴 버그 대응
        ...
        if (cnt > 0) {
            ...
            for (var i = cnt - 1; i >= 0; i--) {
                ...
                sdata += "<value xid=\"" + i + "\">" + formatDate(grid.store.getValue(cm, "OBSDT")) + "</value>";
                gdata1 += "<value xid=\"" + i + "\" description=\"(mm)\">" + grid.store.getValue(cm, "ACURF") + "</value>";
                gdata2 += "<value xid=\"" + i + "\" description=\"(mm)\">" + grid.store.getValue(cm, "RF") + "</value>";
                gdata3 += "<value xid=\"" + i + "\" description=\"(mm)\">" + grid.store.getValue(cm, "EXVL") + "</value>";
                //j++;
            }
            data += sdata + "</series>";
            data += "<graphs>";
    ...
    var layout = [{
        cells: [
            ...
            { field: "OBSNM", name: "관측국명", width: "100px", styles: 'text-align:center;vertical-align:middle;' }
        ],
        noscroll: true,
        width: 'auto'
    }, {
        cells: [[
            ...
            { name: "추정", styles: 'text-align:center;background-color:#efefef;', width: "30%", colSpan: 3, headerClasses: "staticHeader" },
        ], [
            { field: "ACURF", name: "계측우량", width: "50px", styles: 'text-align:center;cursor:hand;', formatter: updateFormatter, constraint: { field: 'EXVL' }, editable: true },
            { field: "RF", name: "시간유량", width: "50px", styles: 'text-align:center;background-color:#efefef;' },
            { field: "EDEXWAYCONT", name: "보정방법", width: "75px", styles: 'text-align:center;background-color:#efefef;' },
            { field: "EXVL", name: "계측우량", width: "50px", styles: 'text-align:center;background-color:#efefef;' },
            { field: "EXRF", name: "시간우량", width: "50px", styles: 'text-align:center;background-color:#efefef;' },
        ...
        cells: [
            { field: "CGEMPNM", name: "보정자", width: "80px", styles: 'text-align:center;vertical-align:middle;background-color:#efefef;cursor:hand;' },
            ...
            { field: "CHKEMPNM", name: "확인자", width: "80px", styles: 'text-align:center;vertical-align:middle;background-color:#efefef;cursor:hand;' },
    ...
    var layoutNoEdit = [{
        ...
        cells: [[
            ...
            { name: "추정", styles: 'text-align:center;', width: "30%", colSpan: 3, headerClasses: "staticHeader" },
        ], [
            { field: "ACURF", name: "계측우량", width: "50px", styles: 'text-align:center;' },
            { field: "RF", name: "시간우량", width: "50px", styles: 'text-align:center;' },
            { field: "EDEXWAYCONT", name: "보정방법", width: "75px", styles: 'text-align:center;' },
            { field: "EXVL", name: "계측우량", width: "50px", styles: 'text-align:center;' },
            { field: "EXRF", name: "시간우량", width: "50px", styles: 'text-align:center;' },
        ...
        cells: [
            { field: "CGEMPNM", name: "보정자", width: "80px", styles: 'text-align:center;vertical-align:middle;cursor:hand;' },
            { field: "CGDT", name: "보정일시", width: "120px", styles: 'text-align:center;vertical-align:middle;cursor:hand;', formatter: formatTextDate },
            { field: "CHKEMPNM", name: "확인자", width: "80px", styles: 'text-align:center;vertical-align:middle;cursor:hand;' },
    ...
    var historyLayout = [{
        cells: [
            { field: "OBSDT", name: "측정일시", width: "120px", styles: 'text-align:center;', formatter: formatTextDate },
            { field: "CGDT", name: "보정일시", width: "120px", styles: 'text-align:center;', formatter: formatTextDate },
...
//    };
    ...
    var searchGrid = function () {
        ...
        grid.setStore(mainStore, rfParams);
        grid.update();

        toggleEditable(rfParams.damCd);
...
//        }
    ...
    var saveConfirm = function () {
        showNewWindow("/Verify/RainFallSaveDialog", window, "dialogHeight:260px;dialogWidth:490px;");
    };
    var toggleChartPanel = function () {
        //alert('toggleChartPanel');
    ...
    var saveData = function (edexlvl, edexway, exrsn, exrsncont, cnds, saveWin) {
        ...
        //alert(edexlvl + " " + edexway + " " + exrsn + " " + exrsncont + " " + cnds + " " + saveWin);
    ...
    var jsonData;
    var ShowNrObsCalc = function () {
        $(document.body).mask();
        showNewWindow("/Verify/RainFallUpdateDialog", window, "dialogHeight:450px;dialogWidth:600px;");
    };
    ...
    var changeDamCd = function () {
        ...
        obsCdOptions = glGetObsCdList('RF', val);
    ...
    var showHistoryDialog = function (ev) {
        if (ev.cellIndex > 9) {
            ...
            showNewWindow("/Verify/RainFallHistoryDialog", window, "dialogHeight:205px;dialogWidth:705px;", true);
        }
    };
    ...
    dojo.ready(function () {
        ...
        gl_excd_R.unshift({ text: '선택하세요', value: '' });
        exCdOptions = gl_excd_R;
     ...
     <table>
        ...
        <tr>
            ...
            <td>
                ...
                <button id="editButton" dojoType="dijit.form.Button" data-dojo-props='id:"editButton"' onClick="ShowNrObsCalc()" ><img src='<%=Page.ResolveUrl("~/Images") %>/icons/border-color.png'> 보 정</button>
...
<input type="hidden" name="fileName" value="우량보정자료.xls" />
</form>
</asp:Content>
