...
<script src="/Common/AllDamCodeJs/?disptp=WL" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var damSearchUrl = "/Verify/GetAllDamWaterlevelList";
    ...
    var searchTpOptions = [
        { text: '수위', value: 'RWL' },
        { text: '수위차', value: 'RWLD' },
        { text: '방류량', value: 'TDQTY' },
        { text: '유입량', value: 'IQTY' },
        { text: '평균우량', value: 'DAMBSARF' }
    ];
    ...
    var DAMBSARFOptions = [
        { text: '일별강우', value: 'DD', selected: true },
        { text: '월별강우', value: 'MM' }
    ];
...
//    ];
    ...
    var damStruct = [{
        cells: [
            { name: '일 자', field: 'OBSDT', width: "100px", styles: 'text-align:center;vertical-align:middle;', formatter: convStrToDateMin }
        ],
        noscroll: true,
        width: 'auto'
    }, {
    ...
    var valueFormatter = function (inValue, rowId, cellId) {
        //console.log("inValue : " + inValue + ", rowId : " + rowId + ", cellId : " + cellId);
        if (inValue == null) {
            //console.log("kk inValue : " + inValue + ", rowId : " + rowId + ", cellId : " + cellId);
            return '<div style="background-color:#BFFFFF">&nbsp;</div>';
        }
        return inValue;
    }
    ...
    var rebuildChartSettings = function () {
        ...
        var searchNm = getSelectText("searchTp");
    ...
    var getParameter = function (url) {
        ...
        //alert(damTp + "==" + damCd + "==" + startDt + "==" + endDt + "==" + dataTp + "==" + searchTp);
        var param = {
            damTp: damTp,
            damCd: damCd,
            startDt: startDt,
    ...
    dojo.ready(function () {
        ...
        var searchTpCombo = $("#searchTp").multiselect({
            header: false,
            multiple: false,
            minWidth: 110,
            height: 150,
            ...
            click: function (e, u) {
                var val = u.value;
                setOptions("dataTp", eval(val + "Options"));
                var dHeight = 150;
                if (val == "RWL") {
                    dHeight = 150;
                } else if (val == "RWLD") {
                    ...
                    dHeight = 90;
                } else if (val == "DAMBSARF") {
                    dHeight = 70;
                }
                $("#dataTp").multiselect({ height: dHeight });
                $("#dataTp").multiselect("refresh");
                createGrid();
            }
        });
...
<div id="search-panel" style="position:absolute;top:50px;left:5px;background-color:#D3E3F8;border:1px solid #B5BCC7;width:99%;height:30px;padding-top:5px;padding-bottom:5px;">
     ...
     <select id="searchTp" class="wsComboBox" style="width:50px;" onchange="changeDataType();"></select>&nbsp;&nbsp;
