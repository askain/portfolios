...
<script type="text/javascript">
    ...
    dojo.ready(function () {
        ...
        setOptions("submitEdExWay", gl_edexway_RF2);
...
<button dojoType="dijit.form.Button" onClick="saveData()"><img src='<%=Page.ResolveUrl("~/Images") %>/icons/disks.png'> 저 장</button></td>
</tr>
</table>
</asp:Content>
