...
<script type="text/javascript">
    ...
    function getMrdPath() {
        if (dataTp == "WL") mrdPath = "/mrd/waterlevel.mrd";
        else if (dataTp == "RF") mrdPath = "/mrd/rainfall.mrd";
        else mrdPath = "/mrd/allwater.mrd";
...
<%
    ...
    string docTitle = "수위자료 보고서";
    if (!string.IsNullOrEmpty(dt) && dt.Equals("RF")) docTitle = "우량자료 보고서";
    else if (!string.IsNullOrEmpty(dt) && dt.Equals("WR")) docTitle = "수위/우량 보고서";
 %>
<br />
