...
<%
    ...
    string alarmCd = Request["alarmcd"];
    string wkcd = Request["wkcd"];
...
<script type="text/javascript">
    ...
    function getParamsForReport() {
        ...
        ///rp [20110901] [20110931] [8] [] [] [댐일별] [댐월별] [댐항목] [관측소일] [관측소월] [관측소항] [수계코드]
        var params = "/rp ";
        params += " [" + startDt + "]";
        params += " [" + endDt + "]";
        params += " [" + dLen + "]";
...
<object id=TChart width=0% height=0% classid="clsid:536600D3-70FE-4C50-92FB-640F6BFC49AD" codebase="<%=Page.ResolveUrl("~/Cab") %>/teechart6.cab#version=6,0,1,1"></object>
</asp:Content>
