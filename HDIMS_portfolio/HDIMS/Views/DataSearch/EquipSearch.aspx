...
<script type="text/javascript">
    ...
    var chartVars = {
        ...
        settings_file: "/Config/Chart/EquipSearchSettings.xml",
        data_file: "/Config/Chart/EquipSearchData.xml",
    ...
    var legendNum = 2;
    var SearchUrl = "/DataSearch/GetEquipSearchList";
    ...
    var getChartData = function () {
        ...
        if (cnt > 0) {
            ...
            for (var i = cnt - 1; i >= 0; i--) {
                ...
                gd1 += "<value xid=\"" + j + "\">" + damGrid.store.getValue(cm, "BATTVOLT") + "</value>";
                gd2 += "<value xid=\"" + j + "\">" + damGrid.store.getValue(cm, "SNR") + "</value>";
                j++;
            }
            data += sdata + "</series>";
            data += "<graphs>";
    ...
    var equipFormatter = function (inValue, rowId, cellId, cellField, cellObj, rowObj) {
        try {
            ...
            var field = cellId.field;
            //console.log(rowId + "," + inValue + "," + cellId.field);
            if (inValue == undefined || inValue == null) ret_val = "-";

            if (field == "BATTVOLT") {
                if (parseInt(inValue) <= 0) {
                    return '<div style="background-color:#ff0000">' + ret_val + '</div>';
                }
            } else if (field == "SECONDARY_CALL") {
                if (inValue == 0) ret_val = "-";
                else if (inValue == 1) ret_val = "위성망(TCP)";
                else if (inValue == 2) ret_val = "유선망";
                else if (inValue == 3) ret_val = "위성망(UDP)";
                else if (inValue == 4) ret_val = "CDMA";
                if (parseInt(inValue) > 0) {
                    return '<div style="background-color:#00ff00">' + ret_val + '</div>';
                }
            } else {
                if (inValue == 0) ret_val = "정상";
                else if (inValue == 1) ret_val = "이상";
                if (parseInt(inValue) > 0) {
                    return '<div style="background-color:#ff0000;color:#ffffff;">' + ret_val + '</div>';
                }
            }
            return ret_val;
        }
    ...
    var damStruct = [{
        cells: [
                ...
                { name: '관측국', field: 'OBSNM', width: "80px", styles: 'text-align:center;vertical-align:middle;' }
            ],
        noscroll: true,
        width: 'auto'
    }, {
        cells: [
                { name: '배터리<br>전압', field: 'BATTVOLT', width: "60px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '배터리<br>상태', field: 'BATTSTS', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'DOOR<br>상태', field: 'DOORSTS', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '수위<br>센서', field: 'WL_SEN', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '우량<br>센서', field: 'RF_SEN', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '수질<br>센서', field: 'WQ_SEN', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '기타<br>센서', field: 'ETC_SEN', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'RTU<br>메모리', field: 'RTU_MEMORY', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'RTU<br>리셋', field: 'RTU_RESET', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                //{ name: '와치독<br>RTU<br>리셋<br>상태', field: 'WDT_RESET', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'LAN<br>포트', field: 'LAN_PORT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'CDMA<br>모뎀', field: 'CDMA_MODEM', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'VSAT<br>포트', field: 'VSAT_PORT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'CDMA<br>포트', field: 'CDMA_PORT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '유선<br>포트', field: 'WIRE_PORT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '멀티<br>케스트', field: 'MULTICAST_SOCKET', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'VSAT<br>이벤트', field: 'VSAT_EVENT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'CDMA<br>이벤트', field: 'CDMA_EVENT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '유선<br>이벤트', field: 'WIRE_EVENT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'UDP<br>이벤트', field: 'UDP_EVENT', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'IDU<br>PING', field: 'IDU_PING', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: 'SNR', field: 'SNR', width: "40px", styles: 'text-align:center;vertical-align:middle;' },
                { name: '주망<br>상태', field: 'PRIMARY_DATA', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '보조망<br>호출', field: 'SECONDARY_CALL', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter },
                { name: '데이터<br>결측', field: 'DATA_STATUS', width: "40px", styles: 'text-align:center;vertical-align:middle;', formatter: equipFormatter }
            ],
        noscroll: false,
        width: 'auto'
    }
...
<input type="hidden" name="fileName" value="설비상태자료.xls" />
</form>
</asp:Content>
